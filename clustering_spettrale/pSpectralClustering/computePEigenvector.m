...
% normalized: true for normalized graph p-Laplacian, false for unnormalized graph p-Laplacian
% vmin: Optional initialization (default: 2nd eigenvector of standard graph Laplacian)
